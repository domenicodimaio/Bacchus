...
with_node \
  ...
  --target "/Users/Domenico/Downloads/Bacchus/ios/Pods/Target Support Files/Pods-Bacchus/ExpoModulesProvider.swift" \
  --entitlement "/Users/Domenico/Downloads/Bacchus/ios/Bacchus/Bacchus.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-localization" "expo-router" "expo-sharing" "expo-splash-screen" "expo-updates" "expo-web-browser"
